          ...
          <div className="flex items-center gap-4 p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {ratingProcessing ? (
                ...
                <p className="text-2xl font-bold" style={{ color: "#5B4FE5" }}>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                ...
                style={{ borderColor: "#5B4FE5", color: "#5B4FE5", backgroundColor: "transparent" }}>
      ...
      <AnimatePresence>
        {ratingProcessing && (
          <motion.div
            ...
            style={{ backgroundColor: "var(--color-card)", borderColor: "#5B4FE5", borderStyle: "dashed" }}>
            <Loader2 className="h-4 w-4 animate-spin flex-shrink-0" style={{ color: "#5B4FE5" }} />
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input {...register("yearsOfExperience", { valueAsNumber: true })} type="number"
              ...
              style={{ ...inputStyle, borderColor: errors.yearsOfExperience ? "#ef4444" : "var(--color-border)", transition: "border-color 0.15s, box-shadow 0.15s" }}
              onFocus={(e) => { if (!errors.yearsOfExperience) { e.currentTarget.style.borderColor = "#5B4FE5"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(91,79,229,0.12)"; } }}
              onBlurCapture={(e) => { e.currentTarget.style.borderColor = errors.yearsOfExperience ? "#ef4444" : "var(--color-border)"; e.currentTarget.style.boxShadow = "none"; }} />
