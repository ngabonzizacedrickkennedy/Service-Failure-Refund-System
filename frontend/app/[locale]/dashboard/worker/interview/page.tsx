      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "gate" && (
          <motion.div key="gate" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            <div className="rounded-2xl border p-8 space-y-5 text-center"
              style={{ backgroundColor: "var(--color-card)", borderColor: "var(--color-border)" }}>
              <div className="h-16 w-16 rounded-full flex items-center justify-center mx-auto"
                style={{ backgroundColor: "#5B4FE520" }}>
                <Video className="h-8 w-8" style={{ color: "#5B4FE5" }} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto text-sm">
                {[
                  ...
                  <div key={it.text} className="flex items-center gap-2 rounded-lg px-3 py-2"
                    ...
                    <span style={{ color: "#5B4FE5" }}>{it.icon}</span>
              ...
              <div className="flex gap-2 mb-4">
                {QUESTIONS.map((_, i) => (
                  <div key={i} className="flex-1 h-1.5 rounded-full"
                    style={{ backgroundColor: i <= currentQ ? "#5B4FE5" : "var(--color-border)" }} />
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  style={{ borderColor: "var(--color-border)", backgroundColor: "var(--color-background)", color: "var(--color-foreground)", transition: "border-color 0.15s, box-shadow 0.15s" }}
        ...
        {stage === "done" && (
          <motion.div key="done" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
            ...
            {existingInterview && (
              <div className="max-w-sm mx-auto rounded-2xl border p-4 text-left space-y-3"
                style={{ backgroundColor: "var(--color-card)", borderColor: "var(--color-border)" }}>
