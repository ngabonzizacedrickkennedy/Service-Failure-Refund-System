...
export default function WorkerProfilePage() {
  ...
  const inputClass = "w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#5B4FE5]/20 focus:border-[#5B4FE5] transition";
  const inputStyle = {
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          {!editingAccount && (
            <button onClick={() => setEditingAccount(true)} className="text-sm font-medium" style={{ color: "#5B4FE5" }}>
              Edit
            </button>
          )}
        </div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          {!editingProfile && (
            <button onClick={() => setEditingProfile(true)} className="text-sm font-medium" style={{ color: "#5B4FE5" }}>
