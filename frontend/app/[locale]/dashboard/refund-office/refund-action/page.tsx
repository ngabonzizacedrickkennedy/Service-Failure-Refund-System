...
export default function RefundActionPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Summary */}
      <div className="rounded-2xl p-4" style={{ backgroundColor: "var(--color-card)", border: "1px solid var(--color-border)" }}>
        <div className="flex flex-wrap gap-8">
          <div>
            <div className="flex items-center gap-1.5 mb-1">
              <CheckCircle className="h-4 w-4" style={{ color: "#22c55e" }} />
              <p className="text-xs font-medium" style={{ color: "var(--color-muted-foreground)" }}>Total Processed</p>
            </div>
            <p className="text-2xl font-bold" style={{ color: "var(--color-foreground)" }}>{refunded.length}</p>
          </div>

          <div className="pl-8" style={{ borderLeft: "1px solid var(--color-border)" }}>
            <div className="flex items-center gap-1.5 mb-1">
              <DollarSign className="h-4 w-4" style={{ color: "#5B4FE5" }} />
              <p className="text-xs font-medium" style={{ color: "var(--color-muted-foreground)" }}>Total Returned</p>
            </div>
          ...
          <div className="pl-8" style={{ borderLeft: "1px solid var(--color-border)" }}>
            <div className="flex items-center gap-1.5 mb-1">
              ...
              <p className="text-xs font-medium" style={{ color: "var(--color-muted-foreground)" }}>Re-Locked</p>
            </div>
            <p className="text-2xl font-bold" style={{ color: "var(--color-foreground)" }}>{reLocked}</p>
          </div>
        </div>
      </div>
