...
export default function EvaluatorProfilePage() {
  ...
  const onAccentFocus = (e: React.FocusEvent<HTMLInputElement>) => {
    e.currentTarget.style.borderColor = "#5B4FE5";
    e.currentTarget.style.boxShadow = "0 0 0 3px rgba(91,79,229,0.12)";
  };
  const onAccentBlur = (e: React.FocusEvent<HTMLInputElement>) => {
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                onFocus={editingAccount ? onAccentFocus : undefined}
                onBlur={editingAccount ? onAccentBlur : undefined}
              />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-medium" style={{ color: "var(--color-muted-foreground)" }}>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1">
              ...
              <input
                ...
                onFocus={editingProfile ? onAccentFocus : undefined}
                onBlur={editingProfile ? onAccentBlur : undefined}
              />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-medium" style={{ color: "var(--color-muted-foreground)" }}>
