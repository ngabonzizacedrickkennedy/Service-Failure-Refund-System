      ...
      {notesModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <motion.div
            ...
            className="w-full max-w-md rounded-2xl border p-6 space-y-4 mx-4"
            style={{ backgroundColor: "var(--color-card)", borderColor: "var(--color-border)" }}>
            ...
            <textarea
              ...
              className="w-full rounded-lg border px-3 py-2 text-sm focus:outline-none resize-none transition"
              style={{
