            ...
            return (
              <button key={c.id}
                ...
                <div className="h-9 w-9 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold"
                  style={{ backgroundColor: isSel ? "#5B4FE5" : "var(--color-muted)", color: isSel ? "#fff" : "var(--color-foreground)" }}>
                  {initials(c.name)}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  {c.subtitle && (
                    <p className="text-xs truncate mt-0.5" style={{ color: "#5B4FE5" }}>{c.subtitle}</p>
                  )}
                </div>
              </button>
            );
            ...
            <div className="flex-1 flex flex-col gap-4 p-4">
              ...
              <div className="flex flex-col gap-1.5 flex-1">
                ...
                <textarea placeholder={`Write your message to ${selected.name}…`}
                  ...
                  className="flex-1 rounded-lg px-3 py-2.5 text-sm outline-none resize-none transition"
              ...
              <div className="flex items-center justify-between">
                ...
                <button onClick={handleSend}
                  ...
                  style={{ backgroundColor: "#5B4FE5", color: "#fff" }}>
      ...
      <div className="flex gap-1 rounded-lg p-1 w-fit"
        ...
        <button onClick={() => setTab("refund-office")}
          ...
          style={{
            ...
            color: tab === "refund-office" ? "#5B4FE5" : "var(--color-muted-foreground)",
        ...
        <button onClick={() => setTab("providers")}
          ...
          style={{
            ...
            color: tab === "providers" ? "#5B4FE5" : "var(--color-muted-foreground)",
