    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          >
            <ShieldCheck className="h-5 w-5" style={{ color: "#5B4FE5" }} />
          </div>
          <div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <select
            ...
            className="rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#5B4FE5] transition"
            style={{
              borderColor: "var(--color-border)",
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border px-2 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-[#5B4FE5] transition"
              style={{
                borderColor: "var(--color-border)",
                backgroundColor: "var(--color-background)",
                color: "var(--color-foreground)",
