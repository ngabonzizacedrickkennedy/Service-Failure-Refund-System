        ...
        <div className="flex flex-col md:flex-row gap-3 items-start md:items-center">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border px-3 py-2 pl-9 text-sm focus:outline-none focus:ring-2 focus:ring-[#5B4FE5] transition"
              style={{
                borderColor: "var(--color-border)",
          ...
          <div className="flex flex-wrap gap-2">
            {ROLE_OPTIONS.map((r) => (
              <button
                ...
                style={{
                  backgroundColor:
                    roleFilter === r ? "#5B4FE5" : "var(--color-background)",
                  color: roleFilter === r ? "#ffffff" : "var(--color-neutral-600)",
                  borderColor:
                    roleFilter === r ? "#5B4FE5" : "var(--color-border)",
                }}
              >
