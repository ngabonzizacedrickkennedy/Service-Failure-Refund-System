      ...
      {project.assignedWorkerId && (
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="px-6 pt-4 pb-3 border-b"
            style={{ borderColor: "var(--color-border)", background: "linear-gradient(135deg, rgba(0,0,0,0.03) 0%, rgba(0,0,0,0.01) 100%)" }}>
              ...
              <>
                ...
                <div className={`grid gap-3 ${displayWorker.matchScore !== null ? "grid-cols-3" : "grid-cols-2"}`}>
                  <div className="rounded-xl p-3 text-center space-y-1"
                    ...
                    <Briefcase className="h-5 w-5 mx-auto" style={{ color: "#5B4FE5" }} />
