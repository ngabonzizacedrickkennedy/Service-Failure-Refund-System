...
const inputBase =
  "w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#5B4FE5]/20 focus:border-[#5B4FE5] transition";
            ...
            {category === "CONSTRUCTION" && (
              ...
              >
                <div
                  ...
                  style={{
                    borderColor: locationError ? "#ef4444" : "#5B4FE540",
                    backgroundColor: "#EEF2FF",
                  }}
                >
                  <div className="flex items-center gap-2">
                    <MapPin className="h-4 w-4" style={{ color: "#5B4FE5" }} />
                    <p className="text-sm font-medium" style={{ color: "#5B4FE5" }}>
          ...
          <div className="space-y-3">
            ...
            {imageEntries.length === 0 && (
              <button
                type="button"
                onClick={() => fileInputRef.current?.click()}
                className="flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-dashed py-6 transition"
