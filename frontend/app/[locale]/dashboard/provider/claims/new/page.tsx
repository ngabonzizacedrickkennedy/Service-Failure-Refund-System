        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="space-y-1.5">
            ...
            <textarea {...register("description")} rows={5}
              ...
              onFocus={(e) => { if (!errors.description) { e.currentTarget.style.borderColor = "#5B4FE5"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(91,79,229,0.12)"; } }}
              onBlur={(e) => { e.currentTarget.style.borderColor = errors.description ? "#ef4444" : "var(--color-border)"; e.currentTarget.style.boxShadow = "none"; }} />
            {errors.description && (
                        ...
                        <div className="space-y-2">
                          {fetchedMessages.length === 0 ? (
                            ...
                            <>
                              ...
                              <p className="text-xs" style={{ color: "#5B4FE5" }}>
