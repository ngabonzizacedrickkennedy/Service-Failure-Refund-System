...
export default function ProviderDashboard() {
  ...
  const modules = [
    { label: "My Projects", desc: "Manage and track service projects", href: "/dashboard/provider/projects", icon: <Briefcase className="h-5 w-5" style={{ color: ACCENT }} /> },
    { label: "My Claims", desc: "Review filed service claims", href: "/dashboard/provider/claims", icon: <FileText className="h-5 w-5" style={{ color: ACCENT }} /> },
    { label: "Messages", desc: "Communicate with workers", href: "/dashboard/provider/messages", icon: <MessageSquare className="h-5 w-5" style={{ color: ACCENT }} /> },
  ];

  const actions = [
    { label: "View & Edit Profile", href: "/dashboard/provider/profile", icon: <User className="h-4 w-4" style={{ color: ACCENT }} /> },
    { label: "Change Password", href: "/dashboard/provider/profile#password", icon: <Shield className="h-4 w-4" style={{ color: ACCENT }} /> },
    { label: "View Alumni", href: "/dashboard/provider/alumni", icon: <GraduationCap className="h-4 w-4" style={{ color: ACCENT }} /> },
    { label: "My Contract", href: "/dashboard/provider/contract", icon: <FileSignature className="h-4 w-4" style={{ color: ACCENT }} /> },
    { label: "Account Settings", href: "/dashboard/provider/account", icon: <Wallet className="h-4 w-4" style={{ color: ACCENT }} /> },
  ];
  ...
  const accountFields = [
    ...
    { icon: <Shield className="h-3.5 w-3.5" />, label: "Role", value: "Project Provider" },
  ];
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: 1100 }}>
      ...
      <motion.div
        ...
        style={{
          ...
          position: "relative",
          overflow: "hidden",
          background: "linear-gradient(135deg, #1d3461 0%, #1e40af 55%, #2563eb 100%)",
        }}
      >
        {/* Decorative orbs */}
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.875rem" }}>
            Manage your projects, claims, and team from your dashboard.
          </p>
