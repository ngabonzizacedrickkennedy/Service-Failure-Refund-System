...
export default function EvaluatorDashboard() {
  ...
  const modules = [
    { label: "Submitted Claims", desc: "Review and evaluate submitted claims", href: "/dashboard/evaluator/claims", icon: <ClipboardCheck className="h-5 w-5" style={{ color: ACCENT }} /> },
    { label: "Justifications", desc: "Assess and respond to justifications", href: "/dashboard/evaluator/justifications", icon: <Scale className="h-5 w-5" style={{ color: ACCENT }} /> },
    { label: "Claim Monitor", desc: "Track status of all claims", href: "/dashboard/evaluator/claim-monitor", icon: <ShieldCheck className="h-5 w-5" style={{ color: ACCENT }} /> },
  ];

  const actions = [
    { label: "View & Edit Profile", href: "/dashboard/evaluator/profile", icon: <User className="h-4 w-4" style={{ color: ACCENT }} /> },
    { label: "Messaging", href: "/dashboard/evaluator/messaging", icon: <MessageSquare className="h-4 w-4" style={{ color: ACCENT }} /> },
  ];
  ...
  const accountFields = [
    ...
    { icon: <Shield className="h-3.5 w-3.5" />, label: "Role", value: "Evaluator" },
  ];
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.875rem" }}>
            Review claims, assess justifications, and monitor outcomes.
          </p>
