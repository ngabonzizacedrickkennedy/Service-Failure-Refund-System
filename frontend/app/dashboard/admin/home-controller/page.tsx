...
const DEFAULT: HomepageSettings = {
  ...
  valueProp: { visible: true, title: "Built for accountability, not excuses.", body: "SSFRS exists because service failures happen — deadlines slip, work goes undelivered, trust breaks down. We built a platform where every claim is backed by evidence, every decision is auditable, and every refund is processed with the same rigor as the projects it protects." },
  differentiators: { visible: true, title: "Why Choose SSFRS", subtitle: "A refund process providers and workers can both trust.", items: [
  ...
  programmes: { visible: true, title: "Our Modules", subtitle: "Every stage of a project, covered end to end.", items: [
  ...
  testimonials: { visible: true, title: "What Our Users Say", items: [
  ...
  partners: { visible: true, title: "Trusted By", items: [
    { name: "", logoUrl: "" }, { name: "", logoUrl: "" }, { name: "", logoUrl: "" },
    { name: "", logoUrl: "" }, { name: "", logoUrl: "" }, { name: "", logoUrl: "" },
  ] },
  finalCta: { visible: true, title: "Ready to protect every project?", subtitle: "Join providers and workers already using SSFRS to file, evaluate, and resolve service claims with full transparency.", ctaText: "Create your account", ctaHref: "/register" },
};
